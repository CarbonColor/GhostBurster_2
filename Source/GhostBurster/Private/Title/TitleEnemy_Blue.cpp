...
void ATitleEnemy_Blue::BeginPlay()
{
	...
	//☆マテリアル
	//体のマテリアルをロード
	TObjectPtr<UMaterial> BodyMaterial = LoadObject<UMaterial>(nullptr, TEXT("/Game/_TeamFolder/Title/Material/M_Blue"));
...
bool ATitleEnemy_Blue::CheckPlayerLightColor(EFlashlight_Color PlayerColor) const
{
	return PlayerColor == EFlashlight_Color::Blue;
}
